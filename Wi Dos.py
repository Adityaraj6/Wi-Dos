...
_/﹋\_                   
 ...
 """)
print("\n****************************************************************")
print("\n* Copyright of DarkKing, 2021 *")
print("\n* https://www.github.com/Adityaraj6 *")
print("\n* NOTE:- Wi-Dos is a firmware that performs Deauth Attacks, ")
print('         A deauthentication attack is often confused with ')
print('         Wi-Fi jamming, as they both block users from accessing Wi-Fi networks. ')
print("\n****************************************************************")
